...
class ScreenMain(LcarsScreen):
    def setup(self, all_sprites):
      ...
      #                  layer=1)
       ...
       #                 layer=1)
        all_sprites.add(LcarsBlockSmall(colours.GREY, (150, 16), "New Product"),
                        layer=1)
        all_sprites.add(LcarsBlockSmall(colours.GREY, (190, 16), "Inventory"),
                        layer=1)
        all_sprites.add(LcarsBlockSmall(colours.GREY, (230, 16), "Inventory Value"),
                        layer=1)
       # all_sprites.add(LcarsBlockLarge(colours.BEIGE, (249, 16), "ENERGY"),
       #                 layer=1)

        #self.ip_address = LcarsText(colours.ORANGE, (445, 327),
        ...
        #                layer=3)
        #all_sprites.add(LcarsText(colours.GREY, (286, 174), "14.3 kWh USED YESTERDAY", 1.5),
        #                layer=3)
        #all_sprites.add(LcarsText(colours.GREY, (330, 174), "1.3 Tb DATA USED THIS MONTH", 1.5),
        #                layer=3)
        self.info_text = all_sprites.get_sprites_from_layer(3)

        # date display
        self.stardate = LcarsText(colours.GREY, (12, 380), "STAR DATE 2711.05 17:54:32", 1.5)
        self.lastClockUpdate = 0
        all_sprites.add(self.stardate, layer=1)

        # buttons
        all_sprites.add(LcarsButton(colours.GREY, (6, 662), "LOGOUT", self.logoutHandler),
                        layer=4)
        ...
        #all_sprites.add(LcarsMoveToMouse(colours.GREY), layer=1)
