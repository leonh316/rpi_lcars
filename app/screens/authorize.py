...
class ScreenAuthorize(LcarsScreen):
    ...
    def setup(self, all_sprites):
        ...
        all_sprites.add(LcarsText(colours.GREY, (261, 229), "Product Inventory System: Login", 2),
                        layer=0)

        all_sprites.add(LcarsText(colours.GREY, (9, 16), "Login PIN = 1234, Developer Mode", 1.5),
                        layer=1)

        all_sprites.add(LcarsText(colours.GREY, (360, -1), "click to enter PIN", 1.5),
                        layer=1)
        
        #all_sprites.add(LcarsText(colours.BLUE, (390, -1), "FAILED ATTEMPTS WILL BE REPORTED", 1.5),layer=1)


        all_sprites.add(LcarsButton(colours.GREY, (320, 130), "1", self.num_1), layer=2)
        all_sprites.add(LcarsButton(colours.GREY, (370, 130), "2", self.num_2), layer=2)
        all_sprites.add(LcarsButton(colours.GREY, (320, 270), "3", self.num_3), layer=2)
        all_sprites.add(LcarsButton(colours.GREY, (370, 270), "4", self.num_4), layer=2)
        all_sprites.add(LcarsButton(colours.GREY, (320, 410), "5", self.num_5), layer=2)
        all_sprites.add(LcarsButton(colours.GREY, (370, 410), "6", self.num_6), layer=2)
        all_sprites.add(LcarsButton(colours.GREY, (320, 550), "7", self.num_7), layer=2)
        all_sprites.add(LcarsButton(colours.GREY, (370, 550), "8", self.num_8), layer=2)
